<<<<<<< HEAD
// This file was a prototype HistoryPage. The project uses `ResultPage` and
// the bottom navigation (`Navigationbarme`) as the canonical full-history UI.
// Keeping this file as a stub to avoid accidental imports; remove if you want
// the file fully deleted from disk.

// Deprecated: use `lib/feature/insightmind/presentation/pages/result_page.dart` instead.
=======
